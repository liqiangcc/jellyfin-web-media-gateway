...
<script>(()=>{
  ...
  const storageKey='gateway.tv.display.v1'; let registration=null, heartbeatTimer=null, renderingTimer=null, reconnecting=false, mediaError=null, renderingInFlight=false, renderingRequest=0, telemetrySequence=0, activationRequired=true, lastAppliedPositionMs=null;
