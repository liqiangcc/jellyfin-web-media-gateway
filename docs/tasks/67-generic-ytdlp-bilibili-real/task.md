...
Formal R11 draft freeze: final draft authority is established only after old R10 execution authority has been revoked; pre-draft materialization commits are non-executable history.
```
